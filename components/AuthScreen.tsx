...
const AuthScreen: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-[#0a0a0a] dark:via-[#121212] dark:to-[#1a1a1a] px-6 py-12 transition-colors duration-500"
    >
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-[#1E1E1E] rounded-[32px] p-8 shadow-lg border border-gray-100 dark:border-[#333]">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-gray-50 dark:bg-[#121212] hover:bg-gray-100 dark:hover:bg-[#1a1a1a] text-gray-900 dark:text-white rounded-[24px] font-semibold transition-all duration-300 mb-6 border border-gray-200 dark:border-white/10 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
          >
